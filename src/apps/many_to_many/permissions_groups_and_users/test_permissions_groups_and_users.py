...
def test_request_create_permissions_group_and_users_relation():
    ...
    response = authenticated_client.post("/users-and-groups", content=request_data)
...
def test_request_delete_permissions_group_and_user_relation():
    ...
    response = authenticated_client.delete(f"/users-and-groups/?user_id={user_id}&permissions_group_id={permissions_group_id}")
