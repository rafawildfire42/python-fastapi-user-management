...
from src.apps.permissions.cruds import permissions_groups
from ..schemas import PermissionGroup, PermissionGroupBase
...
def read_permissions_groups(
    ...
    """
    return permissions_groups.get_permissions_groups(db, skip=skip, limit=limit)
...
def read_permissions_group(permission_group_id: int, db: Session = Depends(get_db)):
    ...
    """
    permission_group: PermissionGroup | None = permissions_groups.get_permissions_group(
...
def delete_permissions_group(permissions_group_id: int, db: Session = Depends(get_db)):
    ...
    """
    return permissions_groups.delete_permissions_group(db, permissions_group_id)
...
def create_permissions_group(
    ...
    """
    return permissions_groups.create_permissions_group(
...
def update_permissions_group(
    ...
    """
    return permissions_groups.update_permissions_group(
